...
<head>
    ...
    <title>WallHints - Crypto Predictor</title>
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Crypto Predictor</h4>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                        <div class="white-box">
                            <h3 class="box-title">Predict Cryptocurrencies</h3>
                            <form action="" method="GET">
                              <div class="row g-2">
                                <div class="col-md">
                                  <div class="form-floating">
                                    <input type="text" name="symbol" class="form-control" id="floatingInputGrid" placeholder="0" required list="crypto_list">
                                    <label for="floatingInputGrid">Search for a Crypto</label>
                                    <datalist id="crypto_list">
                                      <?php
                                        if (($handle = fopen("crypto_list.csv", "r")) !== FALSE) {
