...
<head>
  ...
  <title>WallHints - Stock Predictor</title>
      ...
      <div class="page-breadcrumb bg-white">
        <div class="row align-items-center">
          <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Stock Predictor</h4>
          </div>
        </div>
        <!-- /.col-lg-12 -->
      </div>
                ...
                <div class="row g-2">
                  <div class="col-md">
                    <div class="form-floating">
                      <input type="text" name="symbol" class="form-control" id="floatingInputGrid" placeholder="0" required list="stock_list">
                      <label for="floatingInputGrid">Search for a Stock</label>
                      <datalist id="stock_list">
                        <?php
                        if (($handle = fopen("stock_list.csv", "r")) !== FALSE) {
                  ...
                  <div class="col-md">
                    <div class="form-floating">
                      ...
                      <label for="floatingSelectGrid">Select Range for Market Summary</label>
                    </div>
                  </div>
                  <div class="col-md">
