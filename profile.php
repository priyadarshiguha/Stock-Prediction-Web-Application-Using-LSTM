                            ...
                            <div class="user-bg">
                                <div class="overlay-box">
                                    <div class="user-content">
                                        <img src="plugins/images/users/1.jpg" class="thumb-lg img-circle" alt="img">
                                ...
                                <form class="form-horizontal form-material" action="profile.php" method="post">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="name" placeholder="<?php echo $_SESSION['username'] ?>" class="form-control p-0 border-0">
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label for="example-email" class="col-md-12 p-0">Email</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="email" placeholder="<?php echo $_SESSION['email'] ?>" class="form-control p-0 border-0" name="email" id="example-email">
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
